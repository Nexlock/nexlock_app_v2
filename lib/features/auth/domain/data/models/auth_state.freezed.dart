...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( UserJwtModel? user,  bool isAuthenticated,  bool isLoading,  String? error)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _AuthState() when $default != null:
return $default(_that.user,_that.isAuthenticated,_that.isLoading,_that.error);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( UserJwtModel? user,  bool isAuthenticated,  bool isLoading,  String? error)  $default,) {final _that = this;
switch (_that) {
case _AuthState():
return $default(_that.user,_that.isAuthenticated,_that.isLoading,_that.error);}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( UserJwtModel? user,  bool isAuthenticated,  bool isLoading,  String? error)?  $default,) {final _that = this;
switch (_that) {
case _AuthState() when $default != null:
return $default(_that.user,_that.isAuthenticated,_that.isLoading,_that.error);case _:
  return null;
